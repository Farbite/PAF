          ...
          <div class='col-12'>
            <div class='cell'>
              <div class='card'>
                ...
                <div class='card-body'>
                  <p class='card-text'>".$rc['isi_konten']."</p>
                </div>
                <div class='card-footer text-muted'>
                  Ditulis oleh ".$rc['username']."
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <ul class="list-group list-group-flush">
              <?php foreach ($readMenu as $rm) {
                ?>
                <li class='list-group-item'><a class='nav-link active' aria-current='page' href='#'><?php echo $rm['nama_menu'] ?></a></li>
             <?php }  ?>
            </ul>
          </div>
        </div>
